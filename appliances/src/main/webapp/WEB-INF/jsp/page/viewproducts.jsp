        ...
        <div class="row">
          ...
          <aside class="span3 left-nav">
            ...
            <div class="row">
              <div class="span3">
				...
				<h3>Đơn Đặt Hàng</h3>
				<ul class="toggle">
					<li class="icn_new_article"><a href="/appliances/admin/addorders">New</a></li>
          ...
          <div class="span9">
			<article class="module width_3_quarter">
				<header><h3 class="tabs_involved">Quan Ly San Pham</h3>
				</header>
				...
				<div class="tab_container">
					...
					<c:forEach var="product" items="${adminproducts}">
						<tr> 
							...
							<td>${product.price}</td> 
							<td><input type="image" src="/resources/img/images/icn_edit.png" title="Edit"><input type="image" src="/resources/img/images/icn_trash.png" title="Trash"></td> 
						</tr> 
					</c:forEach>
					</tbody> 
					</table>
                ...
                <ul class="navigation rr">
                 <fmt:parseNumber var="page" integerOnly="true" type="number"
							...
							<c:if test="${page>1 && totalPage !=0}">
								<li><a href="/appliances/admin/viewproducts?isKeepProduct=true&page=${page-1}"
							...
							<c:forEach var="i" begin="1" end="${admintotalPage}">
								...
								<c:if test="${i != page}">
									<li><a href="/appliances/admin/viewproducts?isKeepProduct=true&page=${i}">${i}</a></li>
								</c:if>
							</c:forEach>
