...
<div class="row">
	...
	<div class="span8 logo-wrapper">
		<a href="/appliances" class="logo"> <span class="icon ir">Men
				Style Shop</span>
		</a>
	</div>
	<div class="span4">
		...
		<div class="shopping-cart">
			<span class="icon ir">Cart</span> <span class="text"><a
				href="/appliances/cart"><span class="title">Giỏ hàng</span></a> (<span
				id="cartNumber">${cartNumber}</span> Sản phẩm) - </span> <span
				class="price"><span>VND</span><span class="totalPrice">${totalPrice}</span></span>
		</div>
...
<div class="row main-menu-wrapper">
	...
	<div class="span9">
		<ul class="main-menu clearfix rr" id="main-menu">
			...
			<li id="shop-submenu-area"><a href="/appliances/product"
				id="shop-submenu-trigger">Cửa hàng</a>
				<ul class="row shop-submenu rr">
					<li class="arrow ir">Arrow</li>
					<li class="span2 beta">
						<ul class="rr">
							<li><span class="ir icon">Icon</span> <span class="category">Danh
									mục</span></li>
	...
	<div class="span3">
			<input id="quickSearch" type="text"  class="search-box"
				placeholder="Tìm..." value="" onkeypress="return runSearch(event);" />
	</div>
