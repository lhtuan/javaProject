		...
		<div class="span9">
			<article class="module2 width_3_quarter">
				...
				<div id="adm_right">
					...
					<form action="/appliances/admin/vieworders" method="get">
						<fieldset>
							<label>Người Nhận</label>
							 <input type="text" name = "shippfullname" readonly="readonly" value = "${order.shipfullname}" >
							 <label>Địa Chỉ</label>
							 <input type="text" name = "shippaddress" readonly="readonly" value = "${order.shipaddress}" >
							  <label>Email</label>
							 <input type="text" name = "shippemail" readonly="readonly" value = "${order.shipemail}" >
							  <label>SDT</label>
							 <input type="text" name = "shipphone" readonly="readonly" value = "${order.shipphone}" > 
